...
class _SetupProfilePageState extends State<SetupProfilePage> {
  ...
  late final _FormFieldManager formFieldManager = _FormFieldManager(widget.setupState);
      ...
      child: Form(
        ...
        child: Column(
          children: [
            ...
            Row(
              children: [
                Flexible(child: _createAgeInput()),
                padding(8),
                Flexible(child: _createSexInput()),
              ],
            ),
            _createHeightInput(),
            _createWeightInput(),
...
/// Facilitates form validation and field unit conversion
class _FormFieldManager {
  ...
  String get heightIn {
    final double? height = setupState.height;
  ...
  set heightFt(String heightFt) {
    ...
    final int heightIn = int.tryParse(this.heightIn) ?? 0;
  ...
  set heightIn(String heightIn) {
    ...
    final int heightFt = int.tryParse(this.heightFt) ?? 0;
